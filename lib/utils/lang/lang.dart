abstract class Lang {
  static String startOrgDate = 'Founding year';
  static String orgSize = 'Organization size';
  static String orgProf = 'Proof of company';
  static String loginTitle = 'Login to your Account';
  static String loginSubTitle = 'Welcome back! Select';
  static String loginSubTitle2 = 'the below login methods.';
  static String email = 'Email';
  static String emailHint = 'Enter email ';
  static String password = 'Password';
  static String passwordHint = 'Enter password';
  static String showPassword = 'show';
  static String rememmberMe = 'Remember me';
  static String orgWebsiteLink = 'website link';
  ...
  static String jobSeeker = 'As Job Seeker';
  static String organization = 'As Organization';
  static String autoFillData = 'Autofill Your Profile';
  static String manualFillData = "Manual Fill Your Data";
  static String firstName = 'First Name';
  static String adminFirstName = 'Admin First Name';
  static String adminLastName = 'Admin Last Name';
  static String lastName = 'Last Name';
  static String phone = 'Phone';
  static String industry = 'Industry';
  static String orgCeo = "CEO";
  static String orgCeoHint = "Enter CEO name";
  static String dob = 'Date of Birth';
  static String orgName = "Organization Name";
  static const String orgNameHint = "Enter organization name";
  static String gender = 'Gender';
  static String title = 'Job Title';
  static String nationality = 'Nationality';
  static String careerLevel = 'Career Level';
  static String employmentStatus = 'Employment Status';
  static String brief = 'Brief';
  static String immediateStart = 'Immediate Start';
  static String cv = 'CV';
  ...
  static String phoneHint = 'Enter your phone';
  static String passwordHintReg = '(Minimum 6 characters)';
  static String phoneHintReg = 'Enter your phone';
  static String phoneNote = "Recruiters will contact you on this number";
  static String jobTitleHint = "Enter your job title";
  static String nationalityHint = "Enter your nationality";
  static String briefHint = "Enter a small  brief about your self";
  static String cvHint = "Upload your CV";

  static String confirmPassword = 'Confirm Password';

  static String birthDate = "Birth of date";
