  ...
  void _applyFilters() {
    ...
    if (selectedLocationIndices.isNotEmpty) {
      final List<String> allLocations =
          AppSharedData
              .countries; // Assuming AppSharedData.countries holds locations
    ...
    if (selectedSizeIndices.isNotEmpty) {
      ...
      final List<String> selectedSizes =
          selectedSizeIndices.map((i) => allSizes[i]).toList();
      filteredList =
          filteredList
              .where(
                (orgPost) => selectedSizes.contains(
                  orgPost.organizationSize.toLowerCase(),
                ),
              )
              .toList();
    }
