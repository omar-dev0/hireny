  ...
  Widget build(BuildContext context) {
    final List<Function()?> onChipPressed = [
        ...
        "Financial Services"
          ...
          () => showDynamicBottomSheet(context: context,title: "Select  Job Type" , items: [
        "Full Time",
        "Part Time",
        "Freelance",
        "Seasonal",
        "Fixed-Price",
          ...
          () => showDynamicBottomSheet(context: context,title: "Select Job Location" , items: [
        "On-Site",
        "Remote",
        "Hybrid",
      ]),
          () => showDynamicBottomSheet(context: context,title: "Select Experience Level" , items: [
        "No-experience",
        "Fresher",
        "Intermediate",
        "Expert",
      ]),
          () => showDynamicBottomSheet(context: context,title: "Select Date Posted" , items: [
        "All",
        "Last Hour",
        "Last 24 Hours",
        "Last 7 Days",
        "Last 30 Days",
          ...
          () => showDynamicInputBottomSheet(context: context,title: "Select Salary Range" , minHint: "Min Salary", maxHint: "Max Salary", buttonText: "Filter"),
    ];
    return Scaffold(
            ...
            SliverToBoxAdapter(
              child:     Column(
                ...
                children: [
                  ...
                  Text("Search for your desired job matching your skills",style: AppFonts.secMain,textAlign: TextAlign.center,),
                  SizedBox(height: 20.h,),
            ...
            SliverList.builder(
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  logoImage: "assets/images/google_logo.png", // Replace with your asset path
