...
class AdminLocalDataSource implements AdminDataInterface{
  final List<AdminEntity> fixedAdminData = [
   AdminEntity(adminID: 1, adminName: "Adam", adminEmail: "adam@gmail.com", adminDate: "09-11-2020"),
   AdminEntity(adminID: 2, adminName: "Adam", adminEmail: "adam@gmail.com", adminDate: "09-11-2020"),
   AdminEntity(adminID: 3, adminName: "Adam", adminEmail: "adam@gmail.com", adminDate: "09-11-2020"),
  ...
  Future<void> deleteAdmin(AdminEntity adminEntity) async {
    final index = adminsData.indexWhere((admin) => adminEntity.adminID ==admin.adminID);
    if (index != -1) {
  ...
  Future<List<AdminEntity>> showAdmin() async {
    return adminsData.map((admin) => AdminResponse(
        adminName: admin.adminName,
        adminID: admin.adminID,
        adminEmail: admin.adminEmail,
        adminDate: admin.adminDate)).toList();
  }
