...
import '../manager/org_cubit.dart';
import '../manager/org_state.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Expanded(
              child: BlocBuilder<OrgCubit, OrgStates>(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 16),
                                        Text(
                                          cubit.org[index].orgPresenterName,
                                          style:
                                              Theme.of(
                                                context,
