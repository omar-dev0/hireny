...
class TechApiManager {
  final Dio _dio;
  String? token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..-7DaZkJKmp2MROE02jQxbYYg1vwViTHP_JJDo2PchGA";
  ...
  Future<Result<void>> deleteTechInfo(String id, int deleteID) async {
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        return Error(
          error: "Failed to delete certificate: ${response.statusCode}",
        );
      }
    } catch (e) {
